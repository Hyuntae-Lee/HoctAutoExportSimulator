...
namespace OctGlobal
{
	...
	constexpr int PATTERN_ASCAN_POINTS3 = 256;
	constexpr int PATTERN_NUM_ASCAN_POINTS = 3;
	...
	constexpr int PATTERN_ASCAN_POINTS5_ANGIO = 128;
	...
	constexpr int PATTERN_BSCAN_ANGIO_LINES5 = 128;

	constexpr int PATTERN_LINE_LINES = 1;
	constexpr int PATTERN_CROSS_LINES = 10;
	constexpr int PATTERN_RADIAL_LINES = 12;
	constexpr int PATTERN_RASTER_LINES = 25;
