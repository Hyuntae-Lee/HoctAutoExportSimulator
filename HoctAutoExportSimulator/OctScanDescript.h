...
namespace OctGlobal
{
	...
	{
	public:
		PatternName _name = PatternName::Unknown;
		PatternDomain _domain = PatternDomain::Unknown;
		PatternType _type = PatternType::Unknown;
	...
	public:
		...
		void setup(PatternName name, int numPoints, int numLines,
			...
			_type = PatternHelper::getPatternTypeFromCode(code);
